...
当前仓库处于方案阶段（尚无代码），代码实现以根目录 [AGENTS.md](AGENTS.md) 为准。范围与技术选型均已确认，不需要重新讨论。

- [AGENTS.md](AGENTS.md) — 给编程 agent 的开发手册（Cursor VM 阶段 0；真实验证为 Qwen 小模型 + DeepSeek Harness + OSWorld 1 题）
